          ...
          <div className="mt-6">
            <div className="relative mb-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#0a0a0a] text-white/40">소셜 로그인</span>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                disabled
                className="w-full py-4 px-6 rounded-xl flex items-center justify-center gap-3 bg-white/5 text-white/30 font-medium border border-white/10 cursor-not-allowed"
              >
                ...
                <span className="ml-auto text-xs text-white/20 bg-white/5 px-2 py-0.5 rounded">준비중</span>
              </button>
